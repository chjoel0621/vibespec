...
const VIEWNAME={prd:"PRD",spec:"기능명세서",tree:"트리",ia:"IA",flow:"유저플로우",semantic:"측정 점검"};
const VIEWNAME_EN={prd:"PRD",spec:"Feature Spec",tree:"Tree",ia:"IA",flow:"User Flow",semantic:"Measurement Check"};
...
const SURFACE_EN = {screen:"Screen", panel:"Panel", drawer:"Drawer", modal:"Modal", mode:"Mode"};
